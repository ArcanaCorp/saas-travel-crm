    ...
    return (
        ...
        <nav className="w h-screen bg-surface p-md flex flex-col justify-between" style={{"--w": "300px", "--mnw": "300px"}}>
            ...
            <ul className="flex w-full flex-col gap-sm">
                ...
                <li className="w-full"><Link className={`flex items-center gap-sm w-full h rounded-md text-sm px-sm none ${location === '/dashboard/leads' ? 'text-brand font-medium bg-neutral' : 'bg-hover'}`} style={{"--h": "48px"}} href={'/dashboard/leads'}><IconUserPlus/> Leads</Link></li>
            ...
            <div className="flex flex-col gap-xs">
                <button className="w-full h rounded-md bg-primary text-inverse flex items-center justify-center gap-xs none" style={{"--h": "48px"}}><IconPlus/> Nuevo Lead</button>
